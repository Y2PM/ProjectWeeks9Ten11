...
.\packages\OpenCover.4.6.166\tools\OpenCover.Console.exe^
 ...
 -targetargs:"/noisolation /testcontainer:\"ECommerceTests\bin\Debug\ECommerceTests.dll\""^
  -targetargs:"/noisolation /testcontainer:\"ASPECommerceApplication.Tests\bin\Debug\ASPECommerceApplication.Tests.dll\""^
 -mergebyhash^
